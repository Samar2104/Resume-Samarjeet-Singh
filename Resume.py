...
resume_file = current_dir  / "Samarjeet Resume (4).pdf"
# --- GENERAL SETTINGS ---
...
st.write(
    """
    - ✔️ ME. CSE(AI|ML) Pursuing From Chandigarh University:- 8.67 SGPA
- ✔️ Btech.(CSE)  From Guru Gobind Singh Indraprastha University (GGSIPU):- 8.62 CGPA 
